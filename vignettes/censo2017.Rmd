...
Ahora obtengo el mapa de la provincia y procedo a pegar los datos a la tabla del mapa. Notese que en esta parte uso `censo_tabla()`, funcion que trae la tabla completa y que me ahorra pasos adicionales con dplyr para transformar la columna `geometry` a un formato adecuado para graficar.
```{r, warning=FALSE, message=FALSE}
